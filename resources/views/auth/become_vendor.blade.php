                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            ...
                                            <p class="mb-30">Already have an Become Vendor? <a href="{{ route('vendor.login') }}">Login</a></p>
                                        </div>
                                        <form method="POST" action="{{ route('register.vendor') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required="" name="vendor_shop_name" id="vendor_shop_name" placeholder="Shop Name" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <input type="phone" required="" id="phone" name="phone" placeholder="Phone Number" />
                                            </div>
                                            <div class="form-group">
