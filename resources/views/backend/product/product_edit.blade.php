...
<div class="page-content">
  ...
  <div class="card">
      <div class="card-body p-4">
          ...
          <form action="{{ route('update.product',$product->id)}}" method="post" id="myForm"  >
            @csrf
    ...
    <hr>
    <div class="card">
        <form action="{{ route('update.product.thambnail',$product->id)}}" method="post" id="myForm" enctype="multipart/form-data" >
            @csrf
        <div class="card-body">
