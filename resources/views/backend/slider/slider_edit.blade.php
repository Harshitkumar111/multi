        ...
        <div class="main-body">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('update.slider',$slider->id)}}" method="post" id="myForm" enctype="multipart/form-data" >
                                @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary form-group">
                                    <input type="text" class="form-control" value="{{$slider->short_title}}"  name="short_title"/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="{{ asset($slider->slider_image)}}" alt="Category" style="width:100px; height: 100px;"  >
                                </div>
                            </div>
                            <div class="row">
