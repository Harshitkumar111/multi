        ...
        <div class="main-body">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('active.vendor.approve',$inactivevendordetails->id)}}" method="post" enctype="multipart/form-data" >
                                @csrf
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" name="vendor_shop_name" class="form-control" value="{{ $inactivevendordetails->vendor_shop_name}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="tex" name="vendor_join" class="form-control" value="{{ $inactivevendordetails->vendor_join}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <textarea class="form-control" id="inputAddress2"  name="vendor_short_info" placeholder="Address" rows="3">{{ $inactivevendordetails->vendor_short_info }}</textarea>                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
