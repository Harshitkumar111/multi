                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" name="vendor_shop_name" class="form-control" value="{{ $vendorData->vendor_shop_name}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <select name="vendor_join" class="form-select mb-3" aria-label="Default select example">
                                        ...
                                        <option value="2022" {{ $vendorData->vendor_join == 2202 ? 'selected' : ' ' }} >2022</option>
                                        <option value="2023" {{ $vendorData->vendor_join == 2023 ? 'selected' : ' ' }} >2023</option>
                                        <option value="2024" {{ $vendorData->vendor_join == 2023 ? 'selected' : ' ' }} >2024</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <textarea class="form-control" id="inputAddress2"  name="vendor_short_info" placeholder="Address" rows="3">{{ $vendorData->vendor_short_info }}</textarea>                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
